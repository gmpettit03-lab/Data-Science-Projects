...
* Output to Word via putdocx (Final Version)
* ==============================================================================
clear all
set more off
...
* Create a table with 15 rows and 6 columns
putdocx table za_results = (15, 6), border(all, nil) border(bottom, single) border(top, single)
putdocx table za_results(1,1) = ("Variable")
putdocx table za_results(1,2) = ("Break Type")
putdocx table za_results(1,3) = ("Break Year")
putdocx table za_results(1,4) = ("Min t-stat")
putdocx table za_results(1,5) = ("5% Crit Val")
putdocx table za_results(1,6) = ("Significant?")
...
foreach v of local vars_both {
    ...
    * Extract results using the exact macros from zandrews
    ...
    * Fill the table
    ...
    putdocx table za_results(`row',4) = ("`tstat'")
    putdocx table za_results(`row',5) = ("`crit5'")
    putdocx table za_results(`row',6) = ("`sig'")
...
* 6. Save and Close
putdocx save "NelsonPlosser_ZivotAndrews.docx", replace
disp "Document successfully created: NelsonPlosser_ZivotAndrews.docx"
